...
if (-not $VaultRoot) { throw 'VaultRoot is required. Pass -VaultRoot or create ignored Packages/WorkbenchStateSync/workbenchstatesync.config.psd1 from workbenchstatesync.config.example.psd1.' }
